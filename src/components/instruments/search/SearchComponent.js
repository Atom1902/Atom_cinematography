    ...
    return (
        <div className={theme === 'dark' ? css.searchPageLight : css.searchPageDark}>
            <div className={css.formWrap}>
                ...
                <div className={css.search}><BadgePaperComponent data={'Search Movie'} color={color} width={500} height={50}/></div>
            ...
            <div className={css.badgeWrap}>
                <div className={css.badgeResult}><BadgePaperComponent data={`Search result: `} height={40} color={color}
                                                                      width={250}/></div>
